  ...
  return (
    (n.prototype = {
      ...
      shouldUnpin: function (t) {
        // Always unpin (hide) the navbar if not at the top
        return !t.top;
      },
      
      shouldPin: function (t) {
        var distanceFromTopToShow = 450; // De afstand van de top waarbij de navbar moet verschijnen

        return (t.scrollY <= distanceFromTopToShow && t.direction === "up") || t.top;
      },       
      ...
      update: function (t) {
        if (!t.isOutOfBounds && !this.frozen) {
          if (t.top) {
            this.top();
          } else {
            this.notTop();
          ...
          // Log altijd wanneer we de update functie bereiken
          // console.log('Update called', t);
      
          // Probeer de pin/unpin logica te vereenvoudigen voor testdoeleinden
          if (this.shouldPin(t)) {
            this.pin();
          } else {
            this.unpin();
