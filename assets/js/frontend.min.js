            ...
            if (
              ...
              if (
                ...
                if (!1 !== i) {
                  var l = {
                    map:
                      "/Portfolio/assets/files/displacement_map.jpg",
                    type: "move",
                    speed: 100,
                    filter_x: 10,
                    filter_y: 20,
            ...
            p("body").hasClass("semplice-cursor") &&
              ...
              p("body").on("mouseenter", n, function (s) {
                var n,
                  ...
                  // Check for the #color-mode ID first
                  if (s.currentTarget.id === "color-mode") {
                      i = "contact_button";
                  } else {
                      p.each(mouseovers, function (e, t) {
                          -1 < s.currentTarget.className.indexOf(e.replace(".", "")) && (i = t);
                          -1 < s.currentTarget.className.indexOf("flickity-button") && (a = !0);
                      });
                  }
